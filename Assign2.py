...
class Apriori(object):
    ...
    def get_itemset_from_data(self):
        ...
        itemset = set()  # keep the unique data items
        transaction_list = list() # keep all the transaction in a set
...
def main():
    ...
    data = data_from_txt("data/file.dat")
    # print(data)
    rules, itemset = Apriori(data, 0.25, 0.5).run()
    print('Mined {}\nand found a total of {} association rules:'.format("data/file.dat", len(rules)))
